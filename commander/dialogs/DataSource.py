...
from deposit.commander.dialogs.DataSourceMembers.DataSourcePickle import (DataSourcePickle)
...
class DataSource(Dialog):
	...
	def set_up(self):
		...
		self.tab_pickle = DataSourcePickle(self.model, self.view, self)
		...
		self.tabs.addTab(self.tab_pickle, "Pickle")
