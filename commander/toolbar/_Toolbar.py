...
class Toolbar(CmdDict, ViewChild):
	...
	def __init__(self, model, view):
		...
		CmdDict.__init__(self, AddClass, AddDescriptor, AddObject, AddRelation, Export, Import, ImportDeposit, Connect, RelationName, RemoveClass, RemoveDescriptor, RemoveObject, RemoveRelation, Save)
